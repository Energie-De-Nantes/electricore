...
def historique_snapshot_test() -> pl.LazyFrame:
    ...
    return pl.LazyFrame(
        {
            "pdl": ["PDL00001", "PDL00001", "PDL00001", "PDL00001", "PDL00002", "PDL00002", "PDL00002"],
            "date_evenement": [
            ...
            "evenement_declencheur": ["MES", "MCT", "MCT", "MCT", "MES", "MCT", "RES"],
            "etat_contractuel": [
                "EN SERVICE",
                "EN SERVICE",
                "EN SERVICE",
            ...
            "puissance_souscrite": [6.0, 6.0, 9.0, 9.0, 3.0, 6.0, 6.0],
            ...
            "ref_situation_contractuelle": ["REF001", "REF001", "REF001", "REF001", "REF002", "REF002", "REF002"],
        }
    )
    ...
    return pl.LazyFrame(
        {
            ...
            "base": [1500.0, None, None, None, None, None, None, 800.0, 1100.0, 1400.0, 1650.0],
            "hp": [None, 1800.0, 2100.0, 2700.0, 3000.0, 3600.0, 3900.0, None, None, None, None],
            "hc": [None, 1200.0, 1400.0, 1800.0, 2000.0, 2400.0, 2600.0, None, None, None, None],
            "id_calendrier_distributeur": [
                "DI000001",
                "DI000002",
                "DI000002",
...
def test_pipeline_energie_snapshot(
    ...
    """
    result = pipeline_energie(historique_snapshot_test, releves_snapshot_test).collect()
    ...
    historique_stable = pl.LazyFrame(
        {
            ...
            "date_evenement": [datetime(2024, 1, 1), datetime(2024, 12, 31, 23, 59, 59)],
