...
Usage :
    ...
    uv run --extra ingestion python electricore/ingestion/tools/reset_incremental_state.py --clear

    # Reset à une date (retraite les fichiers depuis cette date)
    uv run --extra ingestion python electricore/ingestion/tools/reset_incremental_state.py 2026-03-17
    uv run --extra ingestion python electricore/ingestion/tools/reset_incremental_state.py  # défaut : 2026-03-17
"""
...
def clear_all_state() -> None:
    ...
    if not DB_PATH.exists():
        ...
        print("   Exécuter depuis le répertoire electricore/ingestion/")
        sys.exit(1)
    ...
    print("   uv run --extra ingestion python -m electricore.ingestion all")
