"""
Loader Odoo pour ElectriCore avec support Polars.

Ce module fournit un connecteur en lecture seule pour charger des données
depuis Odoo via XML-RPC, avec un query builder immutable pour composer
