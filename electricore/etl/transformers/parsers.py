...
def _csv_parser_transformer_base(
    extracted_file: dict, delimiter: str, encoding: str, flux_type: str, column_mapping: dict[str, str]
) -> Iterator[dict]:
    """
...
def create_xml_parser_transformer(
    ...
    def configured_xml_parser(extracted_file: dict) -> Iterator[dict]:
        return _xml_parser_transformer_base(
            extracted_file, row_level, metadata_fields or {}, data_fields or {}, nested_fields or [], flux_type
        )
...
def create_csv_parser_transformer(
    delimiter: str = ",", encoding: str = "utf-8", flux_type: str = "unknown", column_mapping: dict[str, str] = None
):
    """
    ...
    def configured_csv_parser(extracted_file: dict) -> Iterator[dict]:
        return _csv_parser_transformer_base(extracted_file, delimiter, encoding, flux_type, column_mapping or {})
...
def create_json_parser_transformer(
    ...
    def configured_json_parser(extracted_file: dict) -> Iterator[dict]:
        return _json_parser_transformer_base(
            extracted_file, record_path, metadata_fields or {}, data_fields or {}, nested_fields or [], flux_type
        )
...
def _json_r64_transformer_base(extracted_file: dict, flux_type: str) -> Iterator[dict]:
    """
